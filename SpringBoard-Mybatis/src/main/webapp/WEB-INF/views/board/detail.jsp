      ...
      $.ajax({
         ...
         success:function(replyList){
            ...
            for(let i in replyList){
            	...
            	output += "<p><a href='/reply/update?boardId=" + replyList[i].boardId + "&id=" 
            			+ replyList[i].id + "'>수정</a> | ";
                output += "<a href='/reply/delete?boardId=" + replyList[i].boardId + "&id=" 
                		+ replyList[i].id + "' onclick='return confirm(\"정말로 삭제하시겠습니까?\")'>삭제</a></p>";
            	output += "</div>";
            }
